    ...
    <div class="container-xxl mx-auto p-0  position-relative header-2-2" style="font-family: 'Poppins', sans-serif; margin-bottom: 2.25rem;">
      <nav class="navbar navbar-expand-lg navbar-light">
        <a href="#">
          ...
          src="<?php echo base_url();?>assets/image/Logo.svg" alt="" />
        </a>
              ...
              <div class="modal-header border-0" style="padding: 2rem; padding-bottom: 0">
                <a class="modal-title" id="targetModalLabel">
                  <img style="margin-top: 0.5rem"
                    src="<?php echo base_url();?>assets/image/Logo.svg"
                    alt="" />
                </a>
      ...
      <div>
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          <!-- Left Column -->
          <div
            class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center my-auto">
          ...
          <!-- Right Column -->
            ...
            src="<?php echo base_url();?>assets/image/Hero.svg"
            alt="" />
          </div>
        </div>
      </div>
...
<section class="h-100 w-100" style="box-sizing: border-box; background-color: #fff" id="portofolio">
    <div class="content-3-7 overflow-hidden container-xxl mx-auto position-relative"
      style="font-family: 'Poppins', sans-serif; margin-bottom: 3rem;">
        <div class="container mx-auto">
        ...
        <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
            <div class="me-md-3   text-start text-white overflow-hidden mb-5">
                ...
                <div class="row">
                    <div class="col-8"> <p class="caption-text fw-bold">Fashion Landing page</p></div>
                    <div class="col-4"> <p class="caption-text-2">Lihat Detail</p></div>
                </div>
            </div>
            <div class="me-md-3   text-start text-white overflow-hidden mt-5">
                ...
                <div class="row">
                    <div class="col-8"> <p class="caption-text fw-bold">Health & Fitness</p></div>
                    <div class="col-4"> <p class="caption-text-2">Lihat Detail</p></div>
                </div>
            </div>
        </div>
        ...
        <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
            <div class="me-md-3   text-start text-white overflow-hidden mb-5">
                ...
                <div class="row">
                    <div class="col-8"> <p class="caption-text fw-bold">Furniture Shop</p></div>
                    <div class="col-4"> <p class="caption-text-2">Lihat Detail</p></div>
                </div>
            </div>
            <div class="me-md-3   text-start text-white overflow-hidden mt-5">
                ...
                <div class="row">
                    <div class="col-8"> <p class="caption-text fw-bold">IT Solution Provider</p></div>
                    <div class="col-4"> <p class="caption-text-2">Lihat Detail</p></div>
                </div>
            </div>
        </div>
...
<section class="h-100 w-100" style="box-sizing: border-box; background-color: #fff" id="tentang">
    <div class="header-2-2 overflow-hidden container-xxl mx-auto position-relative"
      style="font-family: 'Poppins', sans-serif">
      <div class="container mx-auto">
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <!-- Right Column -->
          <div class="right-column text-center d-flex justify-content-center pe-0">
            <img id="img-fluid" class="h-auto mw-100 d-none d-sm-block"
              src="<?php echo base_url();?>assets/image/Tentang.svg"
              alt="" />
          </div>
        </div>
      </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="carousel-inner">
                ...
                <div class="col">
                        ...
                        <div class="d-flex flex-column h-100 p-5 text-white text-shadow-1">
                            <div class="d-flex justify-content-center">
                            <img src="https://github.com/twbs.png" alt="Bootstrap" width="203" height="203" class="rounded-circle">
                            </div>                      
                            <h2 class="fw-bold caption-text-2 text-center pt-3">Deni  Dwi Handoko</h2>
        ...
        <div class="container mx-auto">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                        <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
                        <div class="me-md-3 p-2  text-start text-white overflow-hidden">
                        <div class="card-item-outline bg-white d-flex flex-column position-relative overflow-hidden ">
                                <div class="d-flex text-muted pt-3">
                        ...
                        <div class=" me-md-3 p-2  text-start overflow-hidden">
                        <div class="card-item-outline bg-white d-flex flex-column position-relative overflow-hidden ">
                                    <div class="d-flex text-muted pt-3">
                                    <img src="<?php echo base_url();?>assets/image/tim/tim2.svg" alt="" width="48px" height="48px" class="p-1"> 
                                    <p class="pb-3 mb-0 small lh-sm price-duration">
